...
import (
	...
	"github.com/switch/fabric-sdk-go-examples/sdkInit"
	"github.com/switch/fabric-sdk-go-examples/service"
	"github.com/switch/fabric-sdk-go-examples/web"
	"github.com/switch/fabric-sdk-go-examples/web/controller"
)
...
func main() {
	...
	initInfo := &sdkInit.InitInfo{
		...
		OrgAdmin:       "Admin",
		OrgName:        "Org1",
		OrdererOrgName: "orderer1.lychee.com",

		ChaincodeID:     EduCC,
		ChaincodeGoPath: os.Getenv("GOPATH"),
		ChaincodePath:   "github.com/switch/fabric-sdk-go-examples/chaincode/",
		UserName:        "User1",
	}
